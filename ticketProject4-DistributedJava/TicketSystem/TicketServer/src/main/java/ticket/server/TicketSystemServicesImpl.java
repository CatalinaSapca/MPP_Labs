...
//    private final ARDatabase repoAR;
//    private final BuyerDatabase repoBuyer;
//    private final SellerDatabase repoSeller;
    ...
    public synchronized Seller login(Seller seller, TicketSystemObserver client) throws ServicesException {
    ...
    public synchronized ArtisticRepresentation updateAR(ArtisticRepresentation artisticRepresentation, TicketSystemObserver client) throws ServicesException, SQLException {
    ...
    public synchronized Buyer addBuyer(Buyer buyer) {
        Buyer b = repoBuyer.save(buyer);
        return b;
    }

    public synchronized void logout(Seller seller, TicketSystemObserver client) throws ServicesException {
    ...
    public synchronized Iterable<ArtisticRepresentation> getAllAR() throws SQLException {
        return repoAR.findAll();
    }

    public synchronized Iterable<ArtisticRepresentation> getAllARFromDate(LocalDateTime date) throws SQLException {
