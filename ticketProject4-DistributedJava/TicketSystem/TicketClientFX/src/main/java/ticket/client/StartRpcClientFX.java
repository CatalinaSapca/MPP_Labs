...
import ticket.client.gui.WindowController;
...
import network.rpcprotocol.TicketSystemServicesRpcProxy;
...
//
//
//        WindowController ctrl = loader.<WindowController>getController();
//        ctrl.setService(server);
//
//        primaryStage.setTitle("TicketToConcert System");
...
//        primaryStage.show();
        ...
        WindowController windowController = mainPageLoader.getController();
        windowController.setService(server1);

        primaryStage.setOnCloseRequest(new EventHandler<WindowEvent>() {
            @Override
            public void handle(WindowEvent event) {
                windowController.logout();
                System.exit(0);
            }
        });
        primaryStage.show();
