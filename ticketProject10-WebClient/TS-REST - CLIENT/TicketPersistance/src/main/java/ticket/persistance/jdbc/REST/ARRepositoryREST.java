package ticket.persistance.jdbc.REST;
...
@Component
public class ARRepositoryREST implements ARRepository {
    ...
    @Autowired
    public ARRepositoryREST(Validator<ArtisticRepresentation> validator, Properties props) {
