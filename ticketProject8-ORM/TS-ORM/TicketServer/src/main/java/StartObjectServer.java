...
import ticket.network.utils.TicketSystemObjectConcurrentServer;
...
public class StartObjectServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            serverProps.load(StartObjectServer.class.getResourceAsStream("/ticketserver.properties"));
        ...
        AbstractServer server = new TicketSystemObjectConcurrentServer(ticketServerPort, ticketServerImpl);
